...
pattern = "\w+@\w+.\w+"
product="Toshiba Toner Cartridge"
category="a"
cate="b"
...
got_path="D:/I2/Project2/F/" + product+"/"+product+"_"+str(cate)+".xlsx"
got=pd.read_excel(got_path)
list_pre_site=list(got['Website'])
list_pre_email=got['Email Id']
m=0
dic1={}
                            ...
                            if lower(str(we.text))=="contact us":
                                ...
                                try:
                                    ...
                                    if z:
                                        ...
                                        email_found=1
                                        list_email.append(z.group(0))
                                        list_pre_email.append(str(z.group(0)))
                                        dic1[str(ele)]=str(z.group(0))
                                    else:
